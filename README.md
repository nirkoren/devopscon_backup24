...
Hi everyone. In order to make it work, please follow the instructions below: 

<ul>
  <li>Make sure JAVA 11 or JAVA 17 (only - (<b>JDK</b> and not only <b>JRE</b>) is running on your laptop</li>
